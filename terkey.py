...
class Terkey:
  ...
  def about(self):
    ...
    {a}https://instagram.com/arpunchs{c}
    My Web Site
    {a}https://linktr.ee/Drawl.Nag{c}
    And if you want to give me some money, you can visit
    {a}https://saweria.co/Dn03{c}
  ...
  {a}3.{c} About
    ...
    if menu == "1":
      ...
      pass
    #print(c+'Silahkan hubungi '+a+'https://instagram.com/arpunchs'+c+' jika ada yang mau di bicarakan terkait tool ini, bisnis atau sekedar bertanya kabar. :v\nTerimakasih ^_^')
